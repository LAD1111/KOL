...
export async function generateScripts(
  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      systemInstruction: `Bạn là một KOL (Key Opinion Leader) hàng đầu trên mạng xã hội, chuyên gia tạo video ngắn viral cho TikTok và Instagram Reels. Giọng điệu của bạn năng động, thuyết phục và chân thực. Bạn biết cách thu hút sự chú ý trong 3 giây đầu tiên và thúc đẩy doanh số bán hàng.
